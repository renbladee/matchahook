...
UI["3"] = Drawing.new("UIGradient", UI["2"])
UI["3"]["Rotation"] = -140
...
UI["4"] = Drawing.new("UIStroke", UI["2"])
UI["4"]["Transparency"] = 0.775
UI["4"]["Color"] = Color3.fromRGB(255, 255, 255)

UI["5"] = Drawing.new("ImageLabel", UI["2"])
...
UI["6"] = Drawing.new("TextLabel", UI["5"])
...
UI["7"] = Drawing.new("ImageLabel", UI["2"])
...
UI["8"] = Drawing.new("LocalScript", UI["1"])
UI["8"]["Name"] = [[Init]]
